...
const casamento = new Data // posso omitir os "()", caso não tenha parâmetro. Recurso do JS
casamento.ano = 2017;
...
const casamentoEsperto = new DataEsperta // posso omitir os "()", caso não tenha parâmetro. Recurso do JS
...
const prod1 = new Produto('Notebook', 3430.07);
const prod2 = new Produto('Mouse Gamer', 31.90, 0.09);
