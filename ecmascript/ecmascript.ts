...
function tuplaParama2(...params: [number, string, boolean]) {
...
console.log(`${(1 + 1) * 30}`);
console.log(`Moto: ${caracteristicas[0]}`);
...
//   return menorNumero;
// }
// const menorNumeroNoArray = menorValor(nums);
...
// Callback (forma antiga de trabalhar com assincronismo no JS)
